...
namespace bd.log.datos
{
    public class LogDbContext : DbContext
    {
        ...
        public DbSet<bd.log.entidades.LogCategory> LogCategories { get; set; }
        public DbSet<bd.log.entidades.LogLevel> LogLevels { get; set; }
        public DbSet<bd.log.entidades.LogEntry> LogEntries { get; set; }
